# Git & GitHub Notes
### What is SCM
SCM is a Source Code Management System used to track and manage the changes in software code.
It helps Developers to Colaborate, maintain code versions and ensure consistency across a project.

### 1. What is Git?
Git is a **version control system**. Think of it like a "save history" for your code — every time you save (commit), Git remembers exactly what changed, who changed it, and when. If something breaks, you can go back in time to an older, working version.
...
Simple way to remember: Git is the engine, GitHub is the garage where you park and show off your car.
